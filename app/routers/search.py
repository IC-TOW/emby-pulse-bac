...
def global_library_search(query: str, request: Request):
    ...
    public_host = cfg.get("emby_public_url") or cfg.get("emby_external_url") or cfg.get("emby_public_host") or cfg.get("emby_host", "")
    ...
    try:
        ...
        for item in items:
            ...
            info = {
                "id": item["Id"], "name": item["Name"], "year": item.get("ProductionYear", "未知"),
